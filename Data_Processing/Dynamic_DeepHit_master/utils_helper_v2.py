...
def f_get_minibatch(mb_size, x, x_mi, label, time, mask1, mask2, mask3, target):
    ...
    tgt_mb   = target[idx, :].astype(int)
    return x_mb, x_mi_mb, k_mb, t_mb, m1_mb, m2_mb, m3_mb, tgt_mb
