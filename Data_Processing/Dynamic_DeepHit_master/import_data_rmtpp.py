...
def import_dataset(data_file, norm_mode = 'standard'):

    df_                = pd.read_csv(data_file)

    bin_list           = ['A01A', 'A02A', 'A02B', 'A03A', 'A03B', 'A03F', 'A04A', 'A05A', 'A06A', 'A07A',
                          'A07B', 'A07D', 'A07E', 'A09A', 'A10A', 'A10B', 'A11C', 'A11D', 'A11G', 'A11H',
                          'A12A', 'A12B', 'A12C', 'A16A', 'B01A', 'B02A', 'B02B', 'B03A', 'B03B', 'B03X',
                          'B05A', 'B05C', 'B05X', 'B06A', 'C01A', 'C01B', 'C01C', 'C01D', 'C01E', 'C02A',
                          'C02C', 'C02D', 'C03A', 'C03B', 'C03C', 'C03D', 'C03X', 'C04A', 'C05A', 'C05B',
                          'C07A', 'C08C', 'C08D', 'C09A', 'C09C', 'C09X', 'C10A', 'D01A', 'D04A', 'D05A',
                          'D06A', 'D06B', 'D07A', 'D08A', 'D10A', 'D11A', 'G01A', 'G02A', 'G02C', 'G03A',
                          'G03B', 'G03C', 'G03D', 'G03X', 'G04B', 'G04C', 'H01A', 'H01B', 'H01C', 'H02A',
                          'H03A', 'H03B', 'H04A', 'H05A', 'H05B', 'J01A', 'J01C', 'J01D', 'J01E', 'J01F',
                          'J01G', 'J01M', 'J01X', 'J02A', 'J04A', 'J05A', 'J06B', 'J07A', 'L01A', 'L01B',
                          'L01C', 'L01D', 'L01X', 'L02A', 'L02B', 'L03A', 'L04A', 'M01A', 'M01C', 'M02A',
                          'M03A', 'M03B', 'M03C', 'M04A', 'M05B', 'N01A', 'N01B', 'N02A', 'N02B', 'N02C',
                          'N03A', 'N04A', 'N04B', 'N05A', 'N05B', 'N05C', 'N06A', 'N06B', 'N06D', 'N07A',
                          'N07B', 'N07X', 'P01A', 'P01B', 'P01C', 'P02B', 'P02C', 'P03A', 'R01A', 'R01B',
                          'R03A', 'R03D', 'R05C', 'R05D', 'R06A', 'S01E', 'S01F', 'S01H', 'S01K', 'V03A',
                          'GENDER', 'BLACK']
    cont_list          = ['Age','ACR', 'ALT', 'AST', 'Albumin', 'CK', 'Creatinine', 'GGT', 'Glucose',
    ...
    num_Category    = int(np.max(pat_info[:, 1]) * 1.2) #or specifically define larger than the max tte, ensure that there is 10 years from max tte
    ...
    target          = time - last_meas

    return DIM, DATA, MASK, data_mi, target
